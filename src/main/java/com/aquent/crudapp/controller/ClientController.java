...
public class ClientController {
	...
	/**
	 * Renders the people list associated with client ID.
	 *
	 * @param clientId the ID of the client
	 * @return list view populated with the list of people associated with current client ID
	 */
	@GetMapping(value = "peopleList/{clientId}")
	public ModelAndView listPeopleByClientId(@PathVariable Integer clientId) {
		ModelAndView mav = new ModelAndView("client/peopleList");
		mav.addObject("client", clientService.readClient(clientId));
		mav.addObject("people", personService.listPeopleByClientId(clientId));
		return mav;
	}
	...
	/**
	 * Validates and saves a new client. On success, the user is redirected to the
	...
	/**
	 * Validates and saves an edited client. On success, the user is redirected to
	...
	/**
	 * Handles client deletion or cancellation, redirecting to the listing page in
	 * either case.
	 *
